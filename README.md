...
- **Chat:** Spanish conversation through the Host and DeepSeek. It extends the shared Finance runtime with the local Filesystem and Git MCP clients, yielding 50 registered tools in total.
